...
>(({ className, ...props }, ref) => (
  <div className="flex items-center gap-2 rounded-xl border border-input bg-background/40 px-3 py-2 backdrop-blur">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center gap-2 rounded-xl px-2 py-2 text-sm outline-none aria-selected:bg-muted/60 aria-selected:text-foreground data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50',
      className,
    )}
    {...props}
  />
